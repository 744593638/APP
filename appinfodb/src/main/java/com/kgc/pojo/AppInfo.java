...
public class AppInfo {
    ...
    public AppInfo(){}
    public AppInfo(int id, String softwareName, String APKName, String supportROM, String interfaceLanguage, Float softwareSize, Date updateDate, int devId, String appInfo, int status, Date onSaleDate, Date offSaleDate, int flatformId, int categoryLevel3, int downloads, int createdBy, Date creationDate, int modifyBy, Date modifyDate, int categoryLevel1, int categoryLevel2, String logoPicPath, String logoLocPath, int versionId) {
        this.id = id;
