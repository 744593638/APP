<%@ page import="com.kgc.pojo.AppInfo" %>
    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
						...
						<tbody>
							<c:forEach var="appVersion" items="${appVersionList }" varStatus="status">
								<tr role="row" class="odd">
									...
									<td><fmt:formatDate value="${appVersion.creationDate }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
        ...
        <form class="form-horizontal form-label-left" action="addversionsave" method="post" enctype="multipart/form-data">
           ...
           <input type="hidden" name="id" name="id" value="${appinfo.id}">
